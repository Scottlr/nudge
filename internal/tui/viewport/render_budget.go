// Package viewport owns shared bounded terminal viewport arithmetic for TUI
// projections. It contains no workflow or application state.
package viewport
...
// RenderBudget bounds one root frame by logical rows and terminal cells.
...
// whole row when either bound would be exceeded.
